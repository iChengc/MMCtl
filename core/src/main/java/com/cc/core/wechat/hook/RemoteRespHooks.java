            ...
            hookMethod(
                    ...
                    new XC_MethodHook() {
                        ...
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            ...
                            try {
                                int type = XposedHelpers.getIntField(param.thisObject, "type");
                                Object response = XposedHelpers.getObjectField(param.thisObject, Wechat.Hook.NetScene.NetSceneResponseCmdBodyKey);
                                response = XposedHelpers.getObjectField(response, Wechat.Hook.NetScene.NetSceneResponseBodyKey);
