...
public class EmojiPanelView extends LinearLayout implements OnKeyBoardStateListener {
    ...
    private void init() {
        ...
        mImageSwitch.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public final class EmojiPanelItemRecyclerAdapter extends RecyclerView.Adapter<EmojiPanelItemViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull EmojiPanelItemViewHolder holder, final int position) {
            if (position == mEmojiBeans.size()) {
                ...
                holder.itemView.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        inputEmoji(mEmojiBeans.get(position).getEmojiName());
                    }});
