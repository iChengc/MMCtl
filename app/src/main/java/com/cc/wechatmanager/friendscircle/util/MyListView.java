package com.cc.wechatmanager.friendscircle.util;
...
public class MyListView extends ListView implements OnScrollListener {
	...
	public void updateUserInfo(User user) {
		this.userInfo = user;
		if (userInfo != null) {
			Glide.with(getContext()).load(user.getAvatar()).dontAnimate().into(logo);
	...
	private void initHeadView(final Context context) {
		...
		circle = headView.findViewById(R.id.circleprogress);
		nameView = headView.findViewById(R.id.textView1);
		logo = headView.findViewById(R.id.imageView2);
