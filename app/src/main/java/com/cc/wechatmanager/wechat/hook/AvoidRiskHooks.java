...
public class AvoidRiskHooks extends BaseXposedHook {
    ...
    private void hideRiskPackagesFromActivityManager(ClassLoader classLoader) {
        hookMethod("android.app.ActivityManager", classLoader, "getRunningServices", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
        ...
        hookMethod("android.app.ActivityManager", classLoader, "getRunningTasks", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                if (!param.hasThrowable() && param.getResult() != null) {
    ...
    private void hideFiles(ClassLoader classLoader) {
        findAndHookMethod("java.io.File", classLoader, "exists", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(XC_MethodHook.MethodHookParam param) throws Throwable {
                final String path = (String) getObjectField(param.thisObject, "path");
                if (path != null) {
