...
package com.cc.wechatmanager.shell.core;
...
public class Shell {
  ...
  public static class SU {
     ...
     *
     * <p>Most apps should never need to invoke this, as neither enforcing status nor su version is
  ...
  public static class Builder {
    ...
    /**
     * Construct a {@link Interactive} instance, try to start the shell, and invoke onCommandResultListener to
   ...
   * the main thread of the application. Any blocking invoke should be run from a background thread.</p>
   *
   * <p>When in debug mode, the code will also excessively log the commands passed to and the output returned from
   * the shell.</p>
   *
   ...
   *
   * <p>The main thread must certainly have a Looper, thus if you invoke {@link Builder#open()} from the main
  ...
  public static class Interactive {
    ...
    /**
     * Internal invoke that launches the shell, starts gobbling, and starts executing commands. See
     * {@link Interactive}
     *
     ...
     * (all commands completed) you should not invoke this method from the main UI thread because it may block for a
    ...
    /**
     * <p>Wait for idle state. As this is a blocking invoke, you should not invoke it from the main UI thread. If you do
